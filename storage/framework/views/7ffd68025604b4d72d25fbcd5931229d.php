    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="md:hidden divide-y divide-gray-100">
            <?php $__empty_1 = true; $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-4 <?php echo e($submission->is_read ? '' : 'bg-green-50/40'); ?> hover:bg-gray-50 transition">
                    <div class="flex items-start justify-between gap-2 mb-2">
                        <div>
                            <p class="font-semibold text-gray-900 text-sm"><?php echo e($submission->name); ?></p>
                            <a href="mailto:<?php echo e($submission->email); ?>" class="text-xs text-green-700 hover:underline block"><?php echo e($submission->email); ?></a>
                            <a href="tel:<?php echo e($submission->phone); ?>" class="text-xs text-gray-500 block"><?php echo e($submission->phone); ?></a>
                        </div>
                    ...
                    <?php if($submission->subject): ?>
                        <p class="text-xs font-medium text-gray-700 truncate mb-1"><?php echo e($submission->subject); ?></p>
                    <?php endif; ?>
                    <p class="text-xs text-gray-400 truncate mb-2"><?php echo e(\Illuminate\Support\Str::limit($submission->message, 80)); ?></p>
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-400"><?php echo e($submission->created_at->format('d M Y, H:i')); ?></span>
                        <div class="flex gap-2">
                            ...
                            <form method="POST"
                                  action="<?php echo e($submission->is_read ? route('admin.contact-submissions.mark-unread', $submission) : route('admin.contact-submissions.mark-read', $submission)); ?>">
                                ...
                                <button type="submit" class="px-2.5 py-1 bg-gray-100 hover:bg-gray-200 text-gray-600 text-xs font-semibold rounded-lg transition">
                                    <?php echo e($submission->is_read ? 'Unread' : 'Mark Read'); ?>

                                </button>
                            </form>
                            <form method="POST" action="<?php echo e(route('admin.contact-submissions.destroy', $submission)); ?>" onsubmit="return confirm('Delete this submission?')">
        ...
        <div class="hidden md:block overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="<?php echo e($submission->is_read ? 'bg-white' : 'bg-green-50/40'); ?> hover:bg-gray-50 transition">
                            <td class="px-5 py-4">
                                <?php if($submission->is_read): ?>
                            ...
                            <td class="px-5 py-4">
                                <a href="mailto:<?php echo e($submission->email); ?>" class="block text-green-700 hover:underline text-xs"><?php echo e($submission->email); ?></a>
                                <a href="tel:<?php echo e($submission->phone); ?>" class="block text-gray-500 text-xs mt-0.5"><?php echo e($submission->phone); ?></a>
                            </td>
                            <td class="px-5 py-4 max-w-[180px]">
                                <p class="text-gray-700 truncate"><?php echo e($submission->subject ?: '—'); ?></p>
                                <p class="text-xs text-gray-400 truncate mt-0.5"><?php echo e(\Illuminate\Support\Str::limit($submission->message, 60)); ?></p>
                            </td>
                            <td class="px-5 py-4 text-gray-500 whitespace-nowrap text-xs">
                                <?php echo e($submission->created_at->format('d M Y')); ?><br>
                                <?php echo e($submission->created_at->format('H:i')); ?>
                            ...
                            <td class="px-5 py-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form method="POST"
                                          action="<?php echo e(route('admin.contact-submissions.destroy', $submission)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/contact-submissions/index.blade.php ENDPATH**/ ?>