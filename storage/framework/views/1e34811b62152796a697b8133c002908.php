...
<?php $component->withAttributes([]); ?>
    <div class="mb-6 sm:mb-8">
        <a href="<?php echo e(route('admin.staff.index')); ?>" class="text-gray-600 hover:text-gray-900 transition text-sm">
            ← <?php echo e(__('app.back_to_staff')); ?>

        </a>
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-3"><?php echo e(__('app.edit_staff_member')); ?></h1>
        <p class="text-gray-600 mt-1 text-sm sm:text-base"><?php echo e(__('app.update_staff_information', ['name' => $staff->name])); ?></p>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/staff/edit.blade.php ENDPATH**/ ?>