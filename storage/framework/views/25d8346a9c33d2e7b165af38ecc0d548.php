...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="text-xs text-red-500 mb-1"><?php echo e($message); ?></p>
                        <?php unset($message);
                        ...
                        <div class="space-y-2 max-h-52 overflow-y-auto pr-1">
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition
                                              <?php echo e(collect(old('service_ids', []))->contains((string)$svc->id) ? 'border-green-400 bg-green-50' : 'border-gray-200 bg-gray-50 hover:border-green-300 hover:bg-green-50'); ?>">
                                    <input type="checkbox"
                                           name="service_ids[]"
                                           value="<?php echo e($svc->id); ?>"
                                           ...
                                           <?php echo e(collect(old('service_ids', []))->contains((string)$svc->id) ? 'checked' : ''); ?>>
                                    <span class="text-sm text-gray-800 leading-snug">
                                        <?php echo e($svc->name); ?>

                                        <span class="text-gray-400 text-xs">· <?php echo e($svc->duration_minutes); ?> min</span>
                                        <?php if($svc->price > 0): ?>
                                            <span class="text-gray-400 text-xs">· <?php echo e(number_format($svc->price, 3)); ?> OMR</span>
                                        <?php endif; ?>
                                    </span>
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    (function () {
        ...
        <?php if(old('start_time') && count(old('service_ids', [])) > 0): ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/bookings/create.blade.php ENDPATH**/ ?>