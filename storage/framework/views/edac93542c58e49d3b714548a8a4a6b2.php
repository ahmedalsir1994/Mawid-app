     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1"><?php echo e(__('app.reference')); ?>: <?php echo e($booking->reference_code); ?></p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-lg font-semibold text-purple-600"><?php echo e($booking->service->name); ?></p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 font-medium">Duration</p>
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($booking->service->duration_minutes); ?> minutes</p>
                </div>
                <div>
                    ...
                    <?php if($booking->staff): ?>
                        <div class="flex items-center space-x-2 mt-1">
                            <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                                <span
                                    class="text-blue-700 font-bold text-sm"><?php echo e(strtoupper(substr($booking->staff->name, 0, 1))); ?></span>
                            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\booking-app\resources\views/admin/bookings/show.blade.php ENDPATH**/ ?>