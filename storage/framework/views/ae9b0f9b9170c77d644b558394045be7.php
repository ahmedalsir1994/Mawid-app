...
<?php $component->withAttributes([]); ?>
    <form method="POST" action="<?php echo e(route('password.store')); ?>">
        ...
        <input lang="en" dir="ltr" type="hidden" name="token" value="<?php echo e($request->route('token')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\booking-app\resources\views\auth\reset-password.blade.php ENDPATH**/ ?>