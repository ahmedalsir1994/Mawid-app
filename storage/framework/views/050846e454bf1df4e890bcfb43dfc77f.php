                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="<?php echo e(route('landing')); ?>" class="flex items-center space-x-2">
                            ...
                            <span
                                class="font-bold text-lg text-gray-800 hidden sm:block"><?php echo e(config('app.name')); ?></span>
                        </a>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex gap-1 bg-gray-100 rounded-lg p-1">
                            <a href="<?php echo e(route('lang.switch', 'en')); ?>"
                                class="px-2 py-1 text-xs font-medium rounded transition <?php echo e(app()->getLocale() === 'en' ? 'bg-purple-600 text-white' : 'text-gray-700 hover:bg-gray-200'); ?>">
                                EN
                            </a>
                            <a href="<?php echo e(route('lang.switch', 'ar')); ?>"
                                class="px-2 py-1 text-xs font-medium rounded transition <?php echo e(app()->getLocale() === 'ar' ? 'bg-purple-600 text-white' : 'text-gray-700 hover:bg-gray-200'); ?>">
                                AR
                            </a>
                        </div>
