...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-right">
            <h1>INVOICE</h1>
            <div class="inv-num"><?php echo e($invoice->invoice_number); ?></div>
            <?php
    ...
    <div class="two-col">
        <div>
            ...
            <div class="biz-name"><?php echo e($invoice->business_name); ?></div>
            <?php if($invoice->business_email): ?>
                <div class="biz-email"><?php echo e($invoice->business_email); ?></div>
            <?php endif; ?>
        </div>
        <div class="two-col-right">
            ...
            <?php if($invoice->paid_at): ?>
                <div class="detail-row">
                    ...
                    <span class="detail-val"><?php echo e($invoice->paid_at->format('d M Y')); ?></span>
                </div>
            <?php endif; ?>
            <?php if($invoice->billing_period_start && $invoice->billing_period_end): ?>
                <div class="detail-row">
                    <span class="detail-label">Period:</span>
                    <span class="detail-val"><?php echo e($invoice->billing_period_start->format('d M Y')); ?> – <?php echo e($invoice->billing_period_end->format('d M Y')); ?></span>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>
                    <div class="item-name">Mawid <?php echo e(ucfirst($invoice->plan)); ?> Plan</div>
                    <?php if($invoice->billing_period_start && $invoice->billing_period_end): ?>
                ...
                <td style="text-align:center; color:#6b7280;"><?php echo e(ucfirst($invoice->billing_cycle ?? '—')); ?></td>
                <td><?php echo e(number_format($invoice->amount, 3)); ?> <?php echo e($invoice->currency ?? 'OMR'); ?></td>
            </tr>
        </tbody>
    </table>
...
<?php /**PATH C:\laragon\www\booking-app\resources\views\admin\billing\invoice-pdf.blade.php ENDPATH**/ ?>