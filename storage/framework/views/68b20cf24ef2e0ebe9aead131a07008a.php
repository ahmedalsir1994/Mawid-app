...
<?php $component->withAttributes([]); ?>
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-wrap items-start justify-between gap-y-4">
            <div>
                <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900"><?php echo e(__('app.staff_management')); ?></h1>
                <p class="text-gray-600 mt-1 text-sm sm:text-base"><?php echo e(__('app.manage_staff_members')); ?></p>
            </div>
                    ...
                    <div class="p-4 hover:bg-gray-50 transition">
                        <div class="flex items-center gap-3 mb-2">
                            <div class="w-9 h-9 bg-green-100 rounded-full flex items-center justify-center shrink-0">
                                <span class="text-green-600 font-bold text-sm"><?php echo e(strtoupper(substr($member->name, 0, 1))); ?></span>
                            </div>
                            ...
                            <?php if($member->is_active): ?>
                                <span class="px-2 py-0.5 text-xs font-semibold rounded-full bg-green-100 text-green-800 shrink-0"><?php echo e(__('app.active')); ?></span>
                            <?php else: ?>
                                <span class="px-2 py-0.5 text-xs font-semibold rounded-full bg-red-100 text-red-800 shrink-0"><?php echo e(__('app.inactive')); ?></span>
                            <?php endif; ?>
                        </div>
                        <div class="flex flex-wrap items-center gap-2 mb-3 text-xs text-gray-500">
                            ...
                            <?php endif; ?>
                            <span><?php echo e($member->created_at->format('M d, Y')); ?></span>
                        </div>
                        <div class="flex gap-3 text-xs">
                            <a href="<?php echo e(route('admin.staff.show', $member)); ?>" class="text-green-600 hover:text-green-900 font-medium"><?php echo e(__('app.view')); ?></a>
                            <a href="<?php echo e(route('admin.staff.edit', $member)); ?>" class="text-blue-600 hover:text-blue-900 font-medium"><?php echo e(__('app.edit')); ?></a>
                            <form action="<?php echo e(route('admin.staff.destroy', $member)); ?>" method="POST" class="inline"
                                ...
                                <button type="submit" class="text-red-600 hover:text-red-900 font-medium"><?php echo e(__('app.delete')); ?></button>
                            </form>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/staff/index.blade.php ENDPATH**/ ?>