...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-8 flex items-start justify-between flex-wrap gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-1 text-sm">Registered <?php echo e($user->created_at->format('D, d M Y \a\t H:i')); ?></p>
        </div>
                ...
                <?php if($business): ?>
                    <div class="flex items-center gap-4 mb-5">
                        <?php if($business->logo): ?>
                            <img src="<?php echo e(asset('storage/' . $business->logo)); ?>"
                                 alt="<?php echo e($business->name); ?>" class="w-14 h-14 rounded-xl object-cover border border-gray-100">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <div>
                            <p class="font-bold text-gray-900 text-lg"><?php echo e($business->name); ?></p>
                            <?php if($business->slug): ?>
                                <p class="text-xs text-gray-400 mt-0.5"><?php echo e($business->slug); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <?php if($license): ?>
                    <div class="grid sm:grid-cols-2 gap-5 text-sm">
                        <div>
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($planColors[$license->plan] ?? 'bg-gray-100 text-gray-600'); ?>">
                        ...
                        <div>
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($statusColors[$license->status] ?? 'bg-gray-100 text-gray-600'); ?>">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700"><?php echo e(ucfirst($license->billing_cycle)); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if($license->expires_at): ?>
                        <div>
                            <p class="text-xs text-gray-400 font-semibold uppercase tracking-wide mb-1">Expires At</p>
                            <p class="text-gray-700"><?php echo e($license->expires_at->format('d M Y')); ?></p>
                        </div>
                        <?php endif; ?>
                        ...
                        <div>
                            ...
                            <p class="text-gray-700"><?php echo e($license->grace_period_ends_at->format('d M Y')); ?></p>
                        </div>
                        <?php endif; ?>
                        <?php if($license->started_at): ?>
                        <div>
                            <p class="text-xs text-gray-400 font-semibold uppercase tracking-wide mb-1">Started At</p>
                            <p class="text-gray-700"><?php echo e($license->started_at->format('d M Y')); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-center">
                    <div class="bg-gray-50 rounded-xl p-4">
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($business->bookings->count()); ?></p>
                        <p class="text-xs text-gray-500 mt-1">Total Bookings</p>
                    </div>
                    <div class="bg-gray-50 rounded-xl p-4">
                        <p class="text-2xl font-bold text-gray-900"><?php echo e($business->users->count()); ?></p>
                        <p class="text-xs text-gray-500 mt-1">Team Members</p>
                    </div>
                    <div class="bg-gray-50 rounded-xl p-4">
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(optional($business->branches)->count() ?? 0); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400"><?php echo e(ucfirst(str_replace('_', ' ', $user->role))); ?></p>
                    </div>
                </div>
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex items-center gap-3">
                        ...
                        <a href="mailto:<?php echo e($user->email); ?>" class="text-blue-700 hover:underline text-xs break-all"><?php echo e($user->email); ?></a>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0">
                            <svg class="w-4 h-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <span class="text-xs <?php echo e($user->is_active ? 'text-green-700 font-semibold' : 'text-red-600 font-semibold'); ?>">
                            <?php echo e($user->is_active ? 'Active Account' : 'Inactive Account'); ?>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xs text-yellow-700 font-semibold">Pending: <?php echo e(ucfirst($user->pending_plan)); ?> / <?php echo e(ucfirst($user->pending_cycle ?? '')); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/registrations/show.blade.php ENDPATH**/ ?>