...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-wrap items-start justify-between gap-y-3">
            <div>
                <h2 class="font-bold text-xl sm:text-2xl md:text-3xl text-gray-800"><?php echo e(__('app.branches')); ?></h2>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/branches/index.blade.php ENDPATH**/ ?>