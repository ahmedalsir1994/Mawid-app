...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900"><?php echo e(__('app.super_admin_dashboard')); ?></h1>
        <p class="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base"><?php echo e(__('app.manage_platform')); ?></p>
    </div>
        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full bg-blue-100 text-blue-700 text-xs font-bold">
                    <?php echo e($totalRegistrations); ?> total
                </span>
            </div>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="font-medium text-gray-900"><?php echo e($reg->name); ?></span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-gray-500"><?php echo e($reg->email); ?></td>
                        <td class="px-6 py-4 text-gray-700"><?php echo e(optional($reg->business)->name ?? '—'); ?></td>
                        <td class="px-6 py-4">
                            <?php if($license): ?>
                                <?php
                                    $planColors = [
                                ...
                                ?>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold <?php echo e($planColor); ?>">
                        ...
                        <td class="px-6 py-4 text-gray-400 whitespace-nowrap"><?php echo e($reg->created_at->format('M d, Y')); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
        ...
        <div class="px-6 py-3 border-t border-gray-100 text-center">
            <a href="<?php echo e(route('admin.super.users.index')); ?>"
               class="text-sm text-blue-600 hover:text-blue-700 font-semibold transition">
                View all <?php echo e($totalRegistrations); ?> registrations &rarr;
            </a>
        </div>
        <?php endif; ?>
    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/dashboard.blade.php ENDPATH**/ ?>