...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-6">
        <nav class="text-sm text-gray-500 mb-2">
            ...
            <span class="text-gray-800 font-medium">Edit <?php echo e($plan->name); ?></span>
        </nav>
        <h1 class="text-2xl font-bold text-gray-900"><?php echo e($plan->emoji); ?> Edit Plan: <?php echo e($plan->name); ?></h1>
        <p class="text-sm text-gray-500 mt-1">Slug: <code class="bg-gray-100 px-1 rounded"><?php echo e($plan->slug); ?></code> — used in license assignments</p>
    </div>

    <div class="max-w-3xl bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
        <form method="POST" action="<?php echo e(route('admin.super.plans.update', $plan)); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="emoji" value="<?php echo e(old('emoji', $plan->emoji)); ?>" required maxlength="10"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="<?php echo e(old('slug', $plan->slug)); ?>" required maxlength="20"
                        pattern="[a-z0-9_-]+"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $plan->name)); ?>" required maxlength="50"
                        class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="tagline" value="<?php echo e(old('tagline', $plan->tagline)); ?>" maxlength="200"
                    class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition">
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="price_monthly" value="<?php echo e(old('price_monthly', $plan->price_monthly)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="price_yearly" value="<?php echo e(old('price_yearly', $plan->price_yearly)); ?>"
                            required min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="price_monthly_display" value="<?php echo e(old('price_monthly_display', $plan->price_monthly_display)); ?>"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Display Yearly per-mo</label>
                        <input type="number" name="price_yearly_display" value="<?php echo e(old('price_yearly_display', $plan->price_yearly_display)); ?>"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Old Monthly Price</label>
                        <input type="number" name="old_price_monthly" value="<?php echo e(old('old_price_monthly', $plan->old_price_monthly)); ?>"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Old Yearly Price</label>
                        <input type="number" name="old_price_yearly" value="<?php echo e(old('old_price_yearly', $plan->old_price_yearly)); ?>"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Monthly Discount %</label>
                        <input type="number" name="discount_monthly" value="<?php echo e(old('discount_monthly', $plan->discount_monthly)); ?>"
                            min="0" max="100"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Yearly Discount %</label>
                        <input type="number" name="discount_yearly" value="<?php echo e(old('discount_yearly', $plan->discount_yearly)); ?>"
                            min="0" max="100"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="max_branches" value="<?php echo e(old('max_branches', $plan->max_branches)); ?>"
                            required min="1"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_staff" value="<?php echo e(old('max_staff', $plan->max_staff)); ?>"
                            required min="1"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_services" value="<?php echo e(old('max_services', $plan->max_services)); ?>"
                            required min="0"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_daily_bookings" value="<?php echo e(old('max_daily_bookings', $plan->max_daily_bookings)); ?>"
                            required min="0"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_monthly_bookings" value="<?php echo e(old('max_monthly_bookings', $plan->max_monthly_bookings)); ?>"
                            min="0"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Sort Order</label>
                        <input type="number" name="sort_order" value="<?php echo e(old('sort_order', $plan->sort_order)); ?>"
                            min="0"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                </div>
            ...
            <div class="flex flex-wrap items-center gap-6">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="whatsapp_reminders" value="1"
                        <?php if(old('whatsapp_reminders', $plan->whatsapp_reminders)): echo 'checked'; endif; ?>
                        class="w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
                    <span class="text-sm text-gray-700">WhatsApp Reminders</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1"
                        <?php if(old('is_active', $plan->is_active)): echo 'checked'; endif; ?>
                        class="w-4 h-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="features_text" rows="5"
                            ...
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm font-mono"><?php echo e(old('features_text', implode("\n", $plan->features ?? []))); ?></textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="cta_label" value="<?php echo e(old('cta_label', $plan->cta_label)); ?>" maxlength="100"
                        ...
                        <div>
                            ...
                            <select name="accent_color"
                                class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                                <option value="gray" <?php if(old('accent_color', $plan->accent_color) === 'gray'): echo 'selected'; endif; ?>>⬜ Gray (default / free)</option>
                                <option value="blue" <?php if(old('accent_color', $plan->accent_color) === 'blue'): echo 'selected'; endif; ?>>🔵 Blue (featured)</option>
                                <option value="green" <?php if(old('accent_color', $plan->accent_color) === 'green'): echo 'selected'; endif; ?>>🟢 Green</option>
                                <option value="purple" <?php if(old('accent_color', $plan->accent_color) === 'purple'): echo 'selected'; endif; ?>>🟣 Purple</option>
                                <option value="orange" <?php if(old('accent_color', $plan->accent_color) === 'orange'): echo 'selected'; endif; ?>>🟠 Orange</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="featured_label" value="<?php echo e(old('featured_label', $plan->featured_label)); ?>" maxlength="50"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/plans/edit.blade.php ENDPATH**/ ?>