...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-wrap items-center gap-3">
            <a href="<?php echo e(route('admin.branches.show', $branch)); ?>" class="p-2 hover:bg-gray-100 rounded-lg transition shrink-0">
                <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
            </a>
            <div>
                <h2 class="font-bold text-xl sm:text-2xl md:text-3xl text-gray-800"><?php echo e(__('app.edit_branch')); ?>: <?php echo e($branch->name); ?></h2>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/branches/edit.blade.php ENDPATH**/ ?>