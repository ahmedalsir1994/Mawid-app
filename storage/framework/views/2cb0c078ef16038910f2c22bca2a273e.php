    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100">
        <div class="p-6 border-b border-gray-200 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.bookings.index')); ?>"
                class="text-purple-600 hover:text-purple-800 text-sm font-medium"><?php echo e(__('app.view_all')); ?></a>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody>
                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm">
                            <button
                                class="text-purple-600 hover:text-purple-800 font-medium"><?php echo e(__('app.view')); ?></button>
                        </td>
                    </tr>
                    <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                        <td class="px-6 py-4 text-sm">
