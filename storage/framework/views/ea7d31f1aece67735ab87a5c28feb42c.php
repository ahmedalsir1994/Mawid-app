        ...
        <form action="<?php echo e(route('admin.super.businesses.update', $business)); ?>" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $business->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="<?php echo e(old('slug', $business->slug)); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                        required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="address" id="address" value="<?php echo e(old('address', $business->address)); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                        required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="country" id="country" value="<?php echo e(old('country', $business->country)); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                        required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="phone" value="<?php echo e(old('phone', $business->phone)); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                        required>
