            ...
            <?php $__empty_1 = true; $__currentLoopData = $registrations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="p-4 hover:bg-gray-50 transition">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900 text-sm"><?php echo e($reg->name); ?></p>
                            <a href="mailto:<?php echo e($reg->email); ?>" class="text-xs text-blue-700 hover:underline"><?php echo e($reg->email); ?></a>
                        </div>
                    </div>
                    <div class="flex flex-wrap items-center gap-2 mb-2 text-xs text-gray-600">
                        <?php if(optional($reg->business)->name): ?>
                            <span class="font-medium text-gray-800"><?php echo e($reg->business->name); ?></span>
                            <span class="text-gray-300">&middot;</span>
                        <?php endif; ?>
                        <?php if(optional($reg->business)->business_type): ?>
                            <span><?php echo e(ucwords(str_replace('_', ' ', $reg->business->business_type))); ?></span>
                        <?php endif; ?>
                        <?php if(optional($reg->business)->phone): ?>
                            <span class="text-gray-300">&middot;</span>
                            <a href="tel:<?php echo e($reg->business->phone); ?>" class="text-gray-500"><?php echo e($reg->business->phone); ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="flex flex-wrap items-center gap-2 mb-3 text-xs">
                        <?php if($license): ?>
                            ...
                            ?>
                            <span class="px-2 py-0.5 rounded-full font-semibold <?php echo e($planColors[$license->plan] ?? 'bg-gray-100 text-gray-600'); ?>">
                                <?php echo e(ucfirst($license->plan)); ?><?php if($license->billing_cycle): ?> / <?php echo e(ucfirst($license->billing_cycle)); ?><?php endif; ?>
                            </span>
                            <span class="px-2 py-0.5 rounded-full font-semibold <?php echo e($statusColors[$license->status] ?? 'bg-gray-100 text-gray-600'); ?>">
                        ...
                        <?php endif; ?>
                        <span class="text-gray-400"><?php echo e($reg->created_at->format('d M Y')); ?></span>
                    </div>
                ...
                <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-5 py-4">
                                ...
                                <?php if(optional($reg->business)->phone): ?>
                                    <a href="tel:<?php echo e($reg->business->phone); ?>" class="text-gray-500 text-xs mt-0.5 block"><?php echo e($reg->business->phone); ?></a>
                                <?php endif; ?>
                            </td>
