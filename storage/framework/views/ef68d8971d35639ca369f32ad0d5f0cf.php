...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-4 px-0">
        <div class="text-center mb-10">
            ...
            <?php else: ?>
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold mb-3"><?php echo e(__('landing.pricing_title')); ?></h2>
        ...
        <div class="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div id="plan-card-free" class="relative bg-white rounded-2xl border <?php echo e($isCurrent ? 'border-2 border-green-400 shadow-lg' : 'border-gray-200'); ?> p-8 hover:shadow-lg transition">
                ...
                <div class="mb-6">
                    <span class="text-3xl sm:text-4xl font-bold text-gray-800"><?php echo e(__('landing.plan_free_price')); ?></span>
                ...
                <div class="mb-6">
                    <div class="cycle-monthly">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="text-sm line-through text-gray-400"><?php echo e($plans['pro']['old_price_monthly'] ?? 10); ?> OMR</span>
                            <span class="text-xs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-full">Save <?php echo e($plans['pro']['discount_monthly'] ?? 35); ?>%</span>
                        </div>
                        <span class="text-3xl sm:text-4xl font-bold text-gray-900"><?php echo e($plans['pro']['price_monthly'] ?? 6.5); ?></span>
                    ...
                    <div class="cycle-yearly" style="display:none">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="text-sm line-through text-gray-400"><?php echo e($plans['pro']['old_price_monthly'] ?? 10); ?> OMR/mo</span>
                            <span class="text-xs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-full">Save <?php echo e($plans['pro']['discount_yearly'] ?? 45); ?>%</span>
                        </div>
                        <div class="flex items-end gap-2">
                            <span class="text-3xl sm:text-4xl font-bold text-gray-900"><?php echo e($plans['pro']['price_yearly_display'] ?? 5.5); ?></span>
                            <span class="text-lg font-semibold text-gray-500 mb-0.5">OMR / <?php echo e(__('landing.per_month')); ?></span>
                        </div>
                        <div class="flex items-center gap-2 mt-1">
                            <span class="text-sm text-gray-500"><?php echo e($plans['pro']['price_yearly'] ?? 66); ?> OMR <?php echo e(__('landing.per_year')); ?></span>
                        </div>
                    </div>
                </div>
                <ul class="space-y-2 mb-8">
            ...
            <div id="plan-card-plus" class="relative bg-white rounded-2xl border <?php echo e($isCurrent && $licenseExpired ? 'border-2 border-red-400 shadow-lg' : ($isCurrent ? 'border-2 border-green-400 shadow-lg' : 'border-gray-200')); ?> p-8 hover:shadow-lg transition">
                ...
                <div class="mb-6">
                    <div class="cycle-monthly">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="text-sm line-through text-gray-400"><?php echo e($plans['plus']['old_price_monthly'] ?? 14); ?> OMR</span>
                            <span class="text-xs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-full">Save <?php echo e($plans['plus']['discount_monthly'] ?? 30); ?>%</span>
                        </div>
                        <span class="text-3xl sm:text-4xl font-bold text-gray-900"><?php echo e($plans['plus']['price_monthly'] ?? 9.8); ?></span>
                        <span class="text-lg font-semibold text-gray-500 ml-1">OMR</span>
                        <span class="text-sm text-gray-500"> / <?php echo e(__('landing.per_month')); ?></span>
                    </div>
                    <div class="cycle-yearly" style="display:none">
                        <div class="flex items-center gap-2 mb-1">
                            <span class="text-sm line-through text-gray-400"><?php echo e($plans['plus']['old_price_monthly'] ?? 14); ?> OMR/mo</span>
                            <span class="text-xs font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-full">Save <?php echo e($plans['plus']['discount_yearly'] ?? 35); ?>%</span>
                        </div>
                        <div class="flex items-end gap-2">
                            <span class="text-3xl sm:text-4xl font-bold text-gray-900"><?php echo e($plans['plus']['price_yearly_display'] ?? 9.1); ?></span>
                            <span class="text-lg font-semibold text-gray-500 mb-0.5">OMR / <?php echo e(__('landing.per_month')); ?></span>
                        </div>
                        <div class="flex items-center gap-2 mt-1">
                            <span class="text-sm text-gray-500"><?php echo e($plans['plus']['price_yearly'] ?? 109.2); ?> OMR <?php echo e(__('landing.per_year')); ?></span>
                        </div>
                    </div>
                </div>
                <ul class="space-y-2 mb-8">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/upgrade/index.blade.php ENDPATH**/ ?>