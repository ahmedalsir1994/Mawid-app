    ...
    <div class="min-h-screen flex items-center justify-center py-8 px-4">
        <div class="w-full max-w-2xl">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 sm:p-12">
                ...
                <div
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="font-semibold text-gray-900"><?php echo e($booking->services_label); ?></p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600 mb-1"><?php echo e(__('app.duration')); ?></p>
                            <p class="font-semibold text-gray-900"><?php echo e($booking->total_duration); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="<?php echo e(route('landing')); ?>"
                        ...
                        <?php echo e(__('app.return_to_home')); ?>
            ...
            <div class="mt-8 text-center text-gray-600 text-sm">
                <p><?php echo e(__('app.questions_contact')); ?></p>
            </div>
        </div>
    </div>
</body>

</html><?php /**PATH C:\laragon\www\Mawid-app\resources\views/public/success.blade.php ENDPATH**/ ?>