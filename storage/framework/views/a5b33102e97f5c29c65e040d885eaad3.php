    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('app.plan')); ?></label>
                        <?php
                        ...
                        ?>
                        <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-bold <?php echo e($planBadge); ?>">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('app.billing_cycle')); ?></label>
                        <span class="inline-block px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-semibold capitalize">
                            <?php echo e($license->billing_cycle ?? 'monthly'); ?>
                            ...
                            <?php if($license->expires_at): ?>
                                ...
                                <small class="text-gray-600">
                                    ...
                                    <?php elseif($license->isExpiring()): ?>
                                        <span class="text-yellow-600">(<?php echo e($license->daysUntilExpiry()); ?> <?php echo e(__('app.days_left_full')); ?>)</span>
                                    <?php elseif($license->isActive()): ?>
                                        <span class="text-green-600">(<?php echo e($license->daysUntilExpiry()); ?> <?php echo e(__('app.days_left_full')); ?>)</span>
                                    <?php endif; ?>
                                </small>
                            <?php else: ?>
        ...
        <div>
            ...
            <div class="bg-gradient-to-br from-green-600 to-green-600 rounded-xl shadow-md p-6 text-white">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        <span class="text-green-100"><?php echo e(__('app.plan')); ?></span>
                        <span class="font-bold capitalize"><?php echo e($planEmoji); ?> <?php echo e(ucfirst($license->plan ?? 'free')); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-green-100"><?php echo e(__('app.status')); ?></span>
                        <span class="font-bold"><?php echo e(ucfirst($license->status)); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-green-100"><?php echo e(__('app.users_used')); ?></span>
