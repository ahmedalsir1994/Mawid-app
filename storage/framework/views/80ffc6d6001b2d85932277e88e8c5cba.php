                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mb-8">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>"
                                ...
                                <?php echo e(__('landing.hero_cta_dashboard')); ?>

                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>"
                                class="cta-button px-8 py-4 text-white font-bold rounded-xl text-center text-lg relative z-10">
                                <?php echo e(__('landing.hero_cta_trial')); ?>
                            ...
                            <a href="<?php echo e(route('login')); ?>"
                                ...
                                <?php echo e(__('landing.hero_cta_signin')); ?>
                    ...
                    <div class="flex items-center gap-6 text-sm">
                        <div class="flex items-center gap-2">
                            ...
                            <span><?php echo e(__('landing.hero_no_card')); ?></span>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg class="w-5 h-5 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                            ...
                            <span><?php echo e(__('landing.hero_setup')); ?></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="booking-mockup float-animation">
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-2xl">
                            <div class="flex justify-between items-center mb-6">
                                <h3 class="font-bold text-gray-800 text-lg"><?php echo e(__('landing.hero_schedule_title')); ?></h3>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    ...
                    <div class="text-gray-600 font-medium"><?php echo e(__('landing.stats_businesses')); ?></div>
                </div>
                <div>
                    <div class="text-5xl font-bold stat-counter mb-2">200K+</div>
                    <div class="text-gray-600 font-medium"><?php echo e(__('landing.stats_bookings')); ?></div>
                </div>
                <div>
                    <div class="text-5xl font-bold stat-counter mb-2">98%</div>
                    <div class="text-gray-600 font-medium"><?php echo e(__('landing.stats_satisfaction')); ?></div>
                </div>
                <div>
                    <div class="text-5xl font-bold stat-counter mb-2">24/7</div>
                    <div class="text-gray-600 font-medium"><?php echo e(__('landing.stats_availability')); ?></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <div
                    ...
                    <?php echo e(__('landing.features_badge')); ?>

                </div>
                <h2 class="text-4xl md:text-5xl font-semibold mb-4"><?php echo e(__('landing.features_title')); ?></h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                    <?php echo e(__('landing.features_subtitle')); ?>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="feature-card border rounded-[10px] p-8">
                    ...
                    <h3 class="text-2xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.feature_1_title')); ?></h3>
                    <p class="text-gray-600 leading-relaxed"><?php echo e(__('landing.feature_1_desc')); ?></p>
                </div>
                ...
                <div class="feature-card border rounded-[10px] p-8">
                    ...
                    <h3 class="text-2xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.feature_2_title')); ?></h3>
                    <p class="text-gray-600 leading-relaxed"><?php echo e(__('landing.feature_2_desc')); ?></p>
                </div>
                ...
                <div class="feature-card border rounded-[10px] p-8">
                    ...
                    <h3 class="text-2xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.feature_3_title')); ?></h3>
                    <p class="text-gray-600 leading-relaxed"><?php echo e(__('landing.feature_3_desc')); ?></p>
                </div>
                ...
                <div class="feature-card border rounded-[10px] p-8">
                    ...
                    <h3 class="text-2xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.feature_4_title')); ?></h3>
                    <p class="text-gray-600 leading-relaxed"><?php echo e(__('landing.feature_4_desc')); ?></p>
                </div>
                ...
                <div class="feature-card border rounded-[10px] p-8">
                    ...
                    <h3 class="text-2xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.feature_5_title')); ?></h3>
                    <p class="text-gray-600 leading-relaxed"><?php echo e(__('landing.feature_5_desc')); ?></p>
                </div>
                ...
                <div class="feature-card border rounded-[10px] p-8">
                    ...
                    <h3 class="text-2xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.feature_6_title')); ?></h3>
                    <p class="text-gray-600 leading-relaxed"><?php echo e(__('landing.feature_6_desc')); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <div class="inline-block px-4 py-2 bg-green-100 text-green-600 rounded-full text-sm font-semibold mb-4">
                    <?php echo e(__('landing.hiw_badge')); ?>

                </div>
                <h2 class="text-4xl md:text-5xl font-semibold mb-4"><?php echo e(__('landing.hiw_title')); ?></h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                    <?php echo e(__('landing.hiw_subtitle')); ?>
            ...
            <div class="grid md:grid-cols-4 gap-8 relative">
                ...
                <div class="text-center relative">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                        <h3 class="text-xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.hiw_step1_title')); ?></h3>
                        <p class="text-gray-600"><?php echo e(__('landing.hiw_step1_desc')); ?></p>
                    </div>
                </div>
                ...
                <div class="text-center relative">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                        <h3 class="text-xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.hiw_step2_title')); ?></h3>
                        <p class="text-gray-600"><?php echo e(__('landing.hiw_step2_desc')); ?></p>
                    </div>
                </div>
                ...
                <div class="text-center relative">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                        <h3 class="text-xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.hiw_step3_title')); ?></h3>
                        <p class="text-gray-600"><?php echo e(__('landing.hiw_step3_desc')); ?></p>
                    </div>
                </div>
                ...
                <div class="text-center relative">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                        <h3 class="text-xl font-bold mb-3 text-gray-800"><?php echo e(__('landing.hiw_step4_title')); ?></h3>
                        <p class="text-gray-600"><?php echo e(__('landing.hiw_step4_desc')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16">
                <div
                    ...
                    <?php echo e(__('landing.testimonials_badge')); ?>

                </div>
                <h2 class="text-4xl md:text-5xl font-semibold mb-4"><?php echo e(__('landing.testimonials_title')); ?></h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                    <?php echo e(__('landing.testimonials_subtitle')); ?>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div
                    ...
                    <p class="text-gray-700 mb-6 text-lg leading-relaxed italic"><?php echo e(__('landing.t1_text')); ?></p>
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="font-bold text-gray-800"><?php echo e(__('landing.t1_name')); ?></p>
                            <p class="text-gray-600 text-sm"><?php echo e(__('landing.t1_role')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-700 mb-6 text-lg leading-relaxed italic"><?php echo e(__('landing.t2_text')); ?></p>
                    <div class="flex items-center">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-green-400 to-green-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                            MW
                        ...
                        <div>
                            <p class="font-bold text-gray-800"><?php echo e(__('landing.t2_name')); ?></p>
                            <p class="text-gray-600 text-sm"><?php echo e(__('landing.t2_role')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <p class="text-gray-700 mb-6 text-lg leading-relaxed italic"><?php echo e(__('landing.t3_text')); ?></p>
                    <div class="flex items-center">
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-green-400 to-green-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                            EC
                        ...
                        <div>
                            <p class="font-bold text-gray-800"><?php echo e(__('landing.t3_name')); ?></p>
                            <p class="text-gray-600 text-sm"><?php echo e(__('landing.t3_role')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="pricing" class="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-12">
                ...
                <h2 class="text-4xl md:text-5xl font-semibold mb-4"><?php echo e(__('landing.pricing_title')); ?></h2>
                <p class="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <p class="text-center text-sm text-gray-500 mt-8">
                <?php echo e(__('landing.plan_no_card')); ?>
    ...
    <section class="hero-gradient text-black py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p class="text-xl md:text-2xl mb-10 text-black-100 leading-relaxed max-w-2xl mx-auto">
                <?php echo e(__('landing.cta_subtitle', ['name' => config('app.name')])); ?>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>"
                        class="cta-button px-10 py-5 text-white font-semibold rounded-xl inline-block text-lg shadow-2xl relative z-10">
                        <?php echo e(__('landing.cta_btn_trial')); ?>
            ...
            <div class="flex flex-wrap justify-center gap-6 text-sm text-black-100">
                <div class="flex items-center gap-2">
                    ...
                    <span><?php echo e(__('landing.cta_trial')); ?></span>
                </div>
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                    ...
                    <span><?php echo e(__('landing.cta_no_card')); ?></span>
                </div>
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
                    ...
                    <span><?php echo e(__('landing.cta_cancel')); ?></span>
                </div>
            </div>
        </div>
    </section>
...
</html><?php /**PATH C:\laragon\www\booking-app\resources\views/landing.blade.php ENDPATH**/ ?>