     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-wrap items-start justify-between gap-y-3">
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('admin.branches.index')); ?>" class="p-2 hover:bg-gray-100 rounded-lg transition shrink-0">
                ...
                <div>
                    <div class="flex flex-wrap items-center gap-2">
                        <h2 class="font-bold text-xl sm:text-2xl md:text-3xl text-gray-800"><?php echo e($branch->name); ?></h2>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/branches/show.blade.php ENDPATH**/ ?>