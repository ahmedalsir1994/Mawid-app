...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="email" class="block text-sm font-semibold text-gray-900 mb-2"><?php echo e(__('app.email')); ?>
                        ...
                        *</label>
                    <input lang="en" dir="ltr" type="email" name="email" id="email" value="<?php echo e(old('email', $user->email)); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent"
...
<?php endif; ?><?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/users/create.blade.php ENDPATH**/ ?>