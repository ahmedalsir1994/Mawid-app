...
<?php $component->withAttributes([]); ?>
    <div class="mb-6 sm:mb-8">
        <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900"><?php echo e(__('app.create_business')); ?></h1>
        <p class="text-gray-600 mt-1 text-sm sm:text-base"><?php echo e(__('app.add_new_business')); ?></p>
    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/businesses/create.blade.php ENDPATH**/ ?>