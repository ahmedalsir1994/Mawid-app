...
<?php $component->withAttributes([]); ?>
    <div class="mb-6 sm:mb-8">
        <div class="flex flex-wrap items-start justify-between gap-y-4">
            <div>
                <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900"><?php echo e($user->name); ?></h1>
                <p class="text-gray-600 mt-1 text-sm sm:text-base"><?php echo e(__('app.user_profile')); ?></p>
            </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/users/show.blade.php ENDPATH**/ ?>