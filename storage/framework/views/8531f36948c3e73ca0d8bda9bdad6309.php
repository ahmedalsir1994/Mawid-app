...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-gray-900"><?php echo e($business->name); ?></h1>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $upcomingBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600"><?php echo e($booking->service->name); ?></p>
...
<?php endif; ?><?php /**PATH C:\laragon\www\booking-app\resources\views/admin/company/dashboard.blade.php ENDPATH**/ ?>