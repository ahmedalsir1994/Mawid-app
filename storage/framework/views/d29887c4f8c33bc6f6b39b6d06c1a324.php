...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-wrap items-start justify-between gap-y-3">
            <div>
                <h2 class="font-bold text-xl sm:text-2xl md:text-3xl text-gray-800"><?php echo e(__('app.services')); ?></h2>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
                    <div class="flex items-start justify-between gap-2">
                        <div class="flex-1 min-w-0">
                            <p class="font-semibold text-gray-800"><?php echo e($service->name); ?></p>
                            <div class="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1">
                                <span class="text-xs text-gray-500">⏱ <?php echo e($service->duration_minutes); ?> <?php echo e(__('app.min')); ?></span>
                                <?php if($service->price !== null): ?>
                                    <span class="text-xs text-gray-500"><?php echo e(number_format($service->price, 2)); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php if($service->is_active): ?>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-800 shrink-0"><?php echo e(__('app.active')); ?></span>
                        <?php else: ?>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-800 shrink-0"><?php echo e(__('app.inactive')); ?></span>
                        <?php endif; ?>
                    </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/services/index.blade.php ENDPATH**/ ?>