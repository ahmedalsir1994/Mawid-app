...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900"><?php echo e(__('app.edit_license')); ?></h1>
        <p class="text-gray-600 mt-1 text-sm sm:text-base"><?php echo e(__('app.update_license_details')); ?></p>
    </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <label class="cursor-pointer">
                        <input type="radio" name="license_type" value="plan" class="sr-only peer"
                            <?php if(old('license_type', $license->license_type ?? 'plan') === 'plan'): echo 'checked'; endif; ?>
                    ...
                    <label class="cursor-pointer">
                        <input type="radio" name="license_type" value="custom" class="sr-only peer"
                            <?php if(old('license_type', $license->license_type ?? 'plan') === 'custom'): echo 'checked'; endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input lang="en" dir="ltr" type="number" name="max_daily_bookings" id="max_daily_bookings"
                            min="0" value="<?php echo e(old('max_daily_bookings', $license->max_daily_bookings ?? 100)); ?>"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                </div>
                <div class="mt-3">
...
<?php endif; ?><?php /**PATH C:\laragon\www\Mawid-app\resources\views/admin/super/licenses/edit.blade.php ENDPATH**/ ?>