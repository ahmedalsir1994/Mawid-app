    ...
    <section class="hero-bg relative overflow-hidden pt-32 pb-24">
        ...
        <div class="relative max-w-5xl mx-auto px-6 text-center">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6">
                {{ __('about.hero_title_1') }}
                <br>
                <span class="gradient-text">{{ __('about.hero_title_2') }}</span>
            </h1>
    ...
    <div class="bg-white border-b border-gray-100 shadow-sm">
        <div class="max-w-5xl mx-auto px-6 py-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-1">{{ __('about.stat_founded') }}</p>
                    <p class="text-2xl font-extrabold text-green-600">{{ __('about.stat_founded_val') }}</p>
                </div>
                <div>
                    <p class="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-1">{{ __('about.stat_country') }}</p>
                    <p class="text-2xl font-extrabold text-green-600">{{ __('about.stat_country_val') }}</p>
                </div>
                <div>
                    <p class="text-xs font-semibold uppercase tracking-widest text-gray-400 mb-1">{{ __('about.stat_focus') }}</p>
                    <p class="text-2xl font-extrabold text-green-600">{{ __('about.stat_focus_val') }}</p>
                </div>
    ...
    <section class="bg-gray-50 py-24">
        <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-3xl p-10 shadow-sm border border-gray-100 card-hover">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mb-4">{{ __('about.mission_title') }}</h2>
                <p class="text-gray-600 leading-relaxed">{{ __('about.mission_body') }}</p>
            </div>
            ...
            <div class="bg-gradient-to-br from-green-600 to-green-800 rounded-3xl p-10 shadow-lg card-hover">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/20 text-white text-xs font-semibold uppercase tracking-widest mb-5">
                    ...
                    {{ __('about.vision_badge') }}
                </div>
                <h2 class="text-2xl font-bold text-white mb-4">{{ __('about.vision_title') }}</h2>
                <p class="text-green-100 leading-relaxed">{{ __('about.vision_body') }}</p>
            </div>
    ...
    <section class="bg-white py-24">
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl font-extrabold text-gray-900">{{ __('about.story_title') }}</h2>
            </div>

            <!-- Timeline -->
            <div class="relative">
                <!-- Vertical line -->
                <div class="absolute {{ app()->getLocale() === 'ar' ? 'right-6 md:right-1/2' : 'left-6 md:left-1/2' }} top-0 bottom-0 w-0.5 story-line opacity-20 transform md:-translate-x-px"></div>
                ...
                <div class="relative flex flex-col md:flex-row items-start md:items-center gap-8 mb-14">
                    <div class="hidden md:flex flex-1 justify-end pe-12">
                        <p class="text-gray-600 leading-relaxed text-right max-w-sm {{ app()->getLocale() === 'ar' ? '' : 'rtl:text-left ltr:text-right' }}">
                            {{ __('about.story_p1') }}
                        </p>
                    </div>
                    ...
                    <div class="flex-1 ps-0 md:ps-12 md:hidden">
                        <p class="text-gray-600 leading-relaxed">{{ __('about.story_p1') }}</p>
                    </div>
                ...
                <div class="relative flex flex-col md:flex-row items-start md:items-center gap-8 mb-14">
                    ...
                    <div class="flex-1 ps-0 md:ps-12">
                        <p class="text-gray-600 leading-relaxed max-w-sm">{{ __('about.story_p2') }}</p>
                    </div>
                </div>
                ...
                <div class="relative flex flex-col md:flex-row items-start md:items-center gap-8">
                    <div class="hidden md:flex flex-1 justify-end pe-12">
                        <p class="text-gray-600 leading-relaxed text-right max-w-sm {{ app()->getLocale() === 'ar' ? '' : '' }}">
                            {{ __('about.story_p3') }}
                        </p>
                    </div>
                    <div class="relative z-10 flex-shrink-0 w-12 h-12 rounded-full bg-green-600 flex items-center justify-center shadow-md shadow-green-200 text-white font-bold text-lg">
                    ...
                    <div class="flex-1 ps-0 md:ps-12 md:hidden">
                        <p class="text-gray-600 leading-relaxed">{{ __('about.story_p3') }}</p>
                    </div>
                    <div class="hidden md:block flex-1 ps-12">
    ...
    <section class="bg-gray-50 py-24">
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="text-center mb-14">
                <span class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-green-50 text-green-600 text-xs font-semibold uppercase tracking-widest mb-4">
                    {{ __('about.founders_badge') }}
                </span>
                <h2 class="text-4xl font-extrabold text-gray-900 mb-3">{{ __('about.founders_title') }}</h2>
                <p class="text-gray-500 max-w-xl mx-auto">{{ __('about.founders_subtitle') }}</p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="founder-card rounded-3xl p-8 shadow-sm border border-gray-100 card-hover">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-1">{{ __('about.founder1_name') }}</h3>
                    <p class="text-green-600 text-sm font-semibold mb-4">{{ __('about.founder1_role') }}</p>
                    <p class="text-gray-600 leading-relaxed text-sm">{{ __('about.founder1_bio') }}</p>
                ...
                <div class="founder-card rounded-3xl p-8 shadow-sm border border-gray-100 card-hover">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-1">{{ __('about.founder2_name') }}</h3>
                    <p class="text-green-700 text-sm font-semibold mb-4">{{ __('about.founder2_role') }}</p>
                    <p class="text-gray-600 leading-relaxed text-sm">{{ __('about.founder2_bio') }}</p>
    ...
    <section class="bg-white py-24">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="text-center mb-14">
                ...
                <h2 class="text-4xl font-extrabold text-gray-900">{{ __('about.values_title') }}</h2>
            </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
                ...
                <div class="rounded-2xl border border-gray-100 p-7 shadow-sm card-hover">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2">{{ __('about.value1_title') }}</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">{{ __('about.value1_desc') }}</p>
                </div>
                ...
                <div class="rounded-2xl border border-gray-100 p-7 shadow-sm card-hover">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2">{{ __('about.value2_title') }}</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">{{ __('about.value2_desc') }}</p>
                </div>
                ...
                <div class="rounded-2xl border border-gray-100 p-7 shadow-sm card-hover">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2">{{ __('about.value3_title') }}</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">{{ __('about.value3_desc') }}</p>
                </div>
                ...
                <div class="rounded-2xl border border-gray-100 p-7 shadow-sm card-hover">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2">{{ __('about.value4_title') }}</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">{{ __('about.value4_desc') }}</p>
                </div>
                ...
                <div class="rounded-2xl border border-gray-100 p-7 shadow-sm card-hover">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2">{{ __('about.value5_title') }}</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">{{ __('about.value5_desc') }}</p>
                </div>
                ...
                <div class="rounded-2xl border border-gray-100 p-7 shadow-sm card-hover">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2">{{ __('about.value6_title') }}</h3>
                    <p class="text-gray-500 text-sm leading-relaxed">{{ __('about.value6_desc') }}</p>
                </div>
