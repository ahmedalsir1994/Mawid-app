<x-admin-layout>
    ...
    <form method="POST"
          action="{{ auth()->user()->role === 'staff' ? route('admin.staff.bookings.manual.store') : route('admin.bookings.manual.store') }}"
          id="walkInForm">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="date" id="dateInput" required
                               ...
                               class="w-full px-4 py-2.5 rounded-xl border {{ $errors->has('date') ? 'border-red-400 bg-red-50' : 'border-gray-200 bg-gray-50' }} text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    </div>
                ...
                {{-- Staff Selection (appears after slot is selected) --}}
                <div id="staffSection" class="hidden bg-white rounded-xl shadow-md border border-gray-100 p-6">
                    ...
                    <input type="hidden" name="staff_user_id" id="staffInput" value="{{ old('staff_user_id') }}">
                    @if($errors->has('staff_user_id'))
                        <p class="text-xs text-red-500 mt-2">{{ $errors->first('staff_user_id') }}</p>
                    @endif
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="customer_name" required
                               ...
                               class="w-full px-4 py-2.5 rounded-xl border {{ $errors->has('customer_name') ? 'border-red-400 bg-red-50' : 'border-gray-200 bg-gray-50' }} text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="tel" name="customer_phone" required
                               ...
                               class="w-full px-4 py-2.5 rounded-xl border {{ $errors->has('customer_phone') ? 'border-red-400 bg-red-50' : 'border-gray-200 bg-gray-50' }} text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="customer_email"
                               ...
                               class="w-full px-4 py-2.5 rounded-xl border {{ $errors->has('customer_email') ? 'border-red-400 bg-red-50' : 'border-gray-200 bg-gray-50' }} text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <div>
                        ...
                        <textarea name="customer_notes" rows="3"
                                  ...
                                  class="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 resize-none">{{ old('customer_notes') }}</textarea>
                    </div>
                </div>
    ...
    <script>
    (function () {
        const slotsUrl = '{{ auth()->user()->role === "staff" ? route("admin.staff.bookings.manual-slots") : route("admin.bookings.manual-slots") }}';
