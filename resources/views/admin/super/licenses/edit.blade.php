<x-admin-layout>
    ...
    <div class="mb-6 sm:mb-8">
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">{{ __('app.edit_license') }}</h1>
        <p class="text-gray-600 mt-1 text-sm sm:text-base">{{ __('app.update_license_details') }}</p>
    </div>
