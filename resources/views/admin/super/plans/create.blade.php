<x-admin-layout>
    ...
    <div class="max-w-3xl bg-white rounded-2xl border border-gray-200 p-6 sm:p-8 shadow-sm">
        <form method="POST" action="{{ route('admin.super.plans.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="emoji" value="{{ old('emoji', '📋') }}" required maxlength="10"
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}" required maxlength="20"
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="price_monthly" value="{{ old('price_monthly', 0) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="price_yearly" value="{{ old('price_yearly', 0) }}"
                            required min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" name="price_monthly_display" value="{{ old('price_monthly_display') }}"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        ...
                        <input type="number" name="price_yearly_display" value="{{ old('price_yearly_display') }}"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        ...
                        <input type="number" name="old_price_monthly" value="{{ old('old_price_monthly', 0) }}"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        ...
                        <input type="number" name="old_price_yearly" value="{{ old('old_price_yearly', 0) }}"
                            min="0" step="0.001"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Monthly Discount % </label>
                        <input type="number" name="discount_monthly" value="{{ old('discount_monthly', 0) }}"
                            min="0" max="100"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Yearly Discount %</label>
                        <input type="number" name="discount_yearly" value="{{ old('discount_yearly', 0) }}"
                            min="0" max="100"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="max_branches" value="{{ old('max_branches', 1) }}"
                            required min="1"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_staff" value="{{ old('max_staff', 1) }}"
                            required min="1"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_services" value="{{ old('max_services', 0) }}"
                            required min="0"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_daily_bookings" value="{{ old('max_daily_bookings', 0) }}"
                            required min="0"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_monthly_bookings" value="{{ old('max_monthly_bookings', 0) }}"
                            min="0"
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                    </div>
                    <div>
            ...
            <div class="flex flex-wrap items-center gap-6">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="whatsapp_reminders" value="1"
                        @checked(old('whatsapp_reminders'))
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="features_text" rows="5"
                            ...
                            class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm font-mono">{{ old('features_text') }}</textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="accent_color"
                                class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 transition text-sm">
                                <option value="gray" @selected(old('accent_color', 'gray') === 'gray')>⬜ Gray (default / free)</option>
                                <option value="blue" @selected(old('accent_color') === 'blue')>🔵 Blue (featured)</option>
                                <option value="green" @selected(old('accent_color') === 'green')>🟢 Green</option>
                                <option value="purple" @selected(old('accent_color') === 'purple')>🟣 Purple</option>
                                <option value="orange" @selected(old('accent_color') === 'orange')>🟠 Orange</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="featured_label" value="{{ old('featured_label', 'Most Popular') }}" maxlength="50"
