<x-admin-layout>
    ...
    <div class="py-4 px-0">
        ...
        <div class="flex flex-col items-center mb-10 gap-3">
            ...
            <p id="yearly-caption" class="text-sm font-medium text-green-700 bg-green-50 border border-green-200 px-4 py-1.5 rounded-full" style="display:none">
            ...
            <div id="plan-card-free" class="relative bg-white rounded-2xl border {{ $isCurrent ? 'border-2 border-green-400 shadow-lg' : 'border-gray-200' }} p-8 hover:shadow-lg transition">
                ...
                @else
                    <form method="POST" action="{{ route('admin.upgrade.initiate') }}">
                        ...
                        <button type="submit" class="w-full py-3 rounded-xl border-2 border-gray-300 text-gray-700 font-semibold hover:bg-gray-50 transition">
                            Downgrade to Free
                        </button>
                    </form>
                @endif
