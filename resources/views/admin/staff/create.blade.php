<x-admin-layout>
    <div class="mb-6 sm:mb-8">
        ...
        <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-3">{{ __('app.add_new_staff_member') }}</h1>
        <p class="text-gray-600 mt-1 text-sm sm:text-base">{{ __('app.create_staff_account') }}</p>
    </div>

    @if(isset($canAdd) && !$canAdd)
        <x-upgrade-modal :license="$license" :plan="$plan" limitType="staff" />
    @else
    <div class="bg-white rounded-xl shadow-md border border-gray-100 p-8">
        <form method="POST" action="{{ route('admin.staff.store') }}" class="space-y-6" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <input lang="en" dir="ltr" type="text" name="name" id="name" value="{{ old('name') }}" required
            ...
            <div>
                ...
                <input lang="en" dir="ltr" type="email" name="email" id="email" value="{{ old('email') }}" required
            ...
            <div>
                ...
                <input lang="en" dir="ltr" type="text" name="title" id="title" value="{{ old('title') }}"
