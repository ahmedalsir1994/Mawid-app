<x-admin-layout>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 space-y-3">
                    <div class="flex items-center text-sm">
                        ...
                        <span class="text-gray-600">{{ __('app.role') }}:</span>
                        <span class="ml-2 font-medium text-gray-900">{{ __('app.staff') }}</span>
                    </div>
                    ...
                    <div class="flex items-center text-sm">
                        ...
                        <span class="text-gray-600">{{ __('app.joined') }}:</span>
                        <span class="ml-2 font-medium text-gray-900">{{ $staff->created_at->format('M d, Y') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-md border border-gray-100 p-6">
                <h3 class="text-xl font-bold text-gray-900 mb-6">{{ __('app.staff_information') }}</h3>

                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-500 mb-1">{{ __('app.full_name') }}</label>
                            <p class="text-base text-gray-900">{{ $staff->name }}</p>
                        </div>

                        <div>
                            <label
                                class="block text-sm font-medium text-gray-500 mb-1">{{ __('app.email_address') }}</label>
                            <p class="text-base text-gray-900">{{ $staff->email }}</p>
                        </div>

                        <div>
                            <label
                                class="block text-sm font-medium text-gray-500 mb-1">{{ __('app.account_status') }}</label>
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-500 mb-1">{{ __('app.member_since') }}</label>
                            <p class="text-base text-gray-900">{{ $staff->created_at->format('F d, Y') }}</p>
                        </div>

                        <div>
                            <label
                                class="block text-sm font-medium text-gray-500 mb-1">{{ __('app.last_updated') }}</label>
                            <p class="text-base text-gray-900">{{ $staff->updated_at->format('F d, Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-blue-50 border border-blue-100 rounded-xl p-6 mt-6">
                <h4 class="font-bold text-blue-900 mb-3">📋 {{ __('app.staff_permissions') }}</h4>
                <ul class="space-y-2 text-sm text-blue-800">
                    ...
                    <li class="flex items-center">
                        ...
                        {{ __('app.receive_booking_notifications') }}
                    </li>
                    <li class="flex items-center">
                        <svg class="w-4 h-4 mr-2 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                        ...
                        {{ __('app.view_calendar_schedules') }}
                    </li>
                </ul>
            </div>
        </div>
