    ...
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <div class="field">
                ...
                <div class="field-value"><span class="code">{{ $license->license_key }}</span></div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-value">
                    ...
                    @endphp
                    <span class="badge {{ $badgeClass }}">{{ $emoji }} {{ ucfirst($license->plan) }}</span>
                    &nbsp;
                    <span style="font-size:13px;color:#6b7280;">{{ ucfirst($license->billing_cycle) }}</span>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-value">
                    <span class="badge {{ $license->payment_status === 'paid' ? 'badge-paid' : 'badge-unpaid' }}">
            ...
            <div class="field">
                ...
                <div class="field-value">${{ number_format($license->price, 2) }}</div>
            </div>
            ...
            <div class="field">
                ...
                <div class="field-value">{{ $license->created_at->format('M d, Y — H:i') }}</div>
            </div>

            <hr class="divider">

            <p style="text-align:center;">
                <a href="{{ $url }}" class="btn">View License in Dashboard</a>
            </p>
        </div>
        <div class="footer">
            <p>{{ config('app.name') }} · Super Admin Alert · {{ now()->format('Y') }}</p>
        </div>
    </div>
</body>
</html>
