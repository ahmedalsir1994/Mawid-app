        ...
        <div class="body">
            ...
            <div class="summary-box">
                ...
                <div class="field" style="margin-top:14px; margin-bottom:0;">
                    ...
                    <div class="field-value" style="font-size:13px; color:#6b7280;">{{ $submission->created_at->format('D, d M Y — H:i') }}</div>
                </div>
            </div>
            ...
            <a href="{{ url('/contact') }}" class="btn">Visit Our Website</a>
        </div>
        <div class="footer">
            <p>© {{ date('Y') }} <a href="{{ url('/') }}">Mawid</a> — Booking made simple.</p>
