...
<head>
    ...
    <meta property="og:title"       content="{{ __('blog.meta_og_title') }}">
    <meta property="og:description" content="{{ __('blog.meta_og_desc') }}">
    <meta property="og:image"       content="{{ asset('/images/Mawid.png') }}">
    <meta property="og:locale"      content="{{ str_replace('-', '_', app()->getLocale() === 'ar' ? 'ar_OM' : 'en_US') }}">
    <meta property="og:site_name"   content="{{ config('app.name') }}">

    {{-- ── Twitter Card ─────────────────────────────────────────────── --}}
    <meta name="twitter:card"        content="summary_large_image">
    <meta name="twitter:title"       content="{{ __('blog.meta_og_title') }}">
    <meta name="twitter:description" content="{{ __('blog.meta_og_desc') }}">
    <meta name="twitter:image"       content="{{ asset('/images/Mawid.png') }}">
    ...
    <main>
        ...
        <section class="bg-white py-14">
            <div class="max-w-6xl mx-auto px-6">
                ...
                <div class="flex items-center gap-2 mb-7">
                    ...
                    <span class="text-xs font-bold uppercase tracking-widest text-green-600">{{ __('blog.featured_label') }}</span>
                </div>

                <article class="featured-gradient rounded-3xl overflow-hidden shadow-xl grid md:grid-cols-5" aria-label="{{ __('blog.featured_title') }}">
                    ...
                    <div class="hidden md:flex md:col-span-2 items-center justify-center p-12 relative">
                        ...
                        <div class="relative text-center">
                            ...
                            <p class="text-green-300 text-sm font-semibold">{{ __('blog.featured_category') }}</p>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-4">
                            <div class="flex items-center gap-3 text-sm text-green-300">
                                <div class="w-8 h-8 rounded-full bg-green-600 flex items-center justify-center text-white text-xs font-bold">
                                    {{ mb_strtoupper(mb_substr(__('blog.featured_author'), 0, 1)) }}
                                </div>
                                <span>{{ __('blog.by') }} <strong class="text-white">{{ __('blog.featured_author') }}</strong></span>
                                <span>·</span>
                                <time datetime="2026-03-01">{{ __('blog.featured_date') }}</time>
                                <span>·</span>
                                <span>{{ __('blog.featured_read_time') }}</span>
                            </div>
        ...
        <section class="bg-gray-50 py-14">
            <div class="max-w-6xl mx-auto px-6">
                ...
                <div class="flex items-center gap-2 mb-9">
                    <span class="w-7 h-0.5 bg-green-600 rounded-full"></span>
                    <span class="text-xs font-bold uppercase tracking-widest text-green-600">{{ __('blog.latest_posts') }}</span>
                </div>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
                    ...
                    <article class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 card-hover flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            <span class="inline-block px-2.5 py-0.5 rounded-full bg-green-50 text-green-700 cat-badge font-bold uppercase tracking-wider mb-3 w-fit">{{ __('blog.p1_category') }}</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-3 leading-snug">
                                <a href="#" class="hover:text-green-700 transition">{{ __('blog.p1_title') }}</a>
                            </h3>
                            <p class="text-gray-500 text-sm leading-relaxed flex-1 mb-5">{{ __('blog.p1_excerpt') }}</p>
                            <footer class="flex items-center justify-between text-xs text-gray-400 pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center text-white font-bold" style="font-size:10px">
                                        {{ mb_strtoupper(mb_substr(__('blog.p1_author'), 0, 1)) }}
                                    </div>
                                    <span>{{ __('blog.p1_author') }}</span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <time datetime="2026-02-25">{{ __('blog.p1_date') }}</time>
                                    <span>·</span>
                                    <span>{{ __('blog.p1_read_time') }}</span>
                                </div>
                            </footer>
                        </div>
                    </article>
                    ...
                    <article class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 card-hover flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            <span class="inline-block px-2.5 py-0.5 rounded-full bg-green-50 text-green-700 cat-badge font-bold uppercase tracking-wider mb-3 w-fit">{{ __('blog.p2_category') }}</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-3 leading-snug">
                                <a href="#" class="hover:text-green-700 transition">{{ __('blog.p2_title') }}</a>
                            </h3>
                            <p class="text-gray-500 text-sm leading-relaxed flex-1 mb-5">{{ __('blog.p2_excerpt') }}</p>
                            <footer class="flex items-center justify-between text-xs text-gray-400 pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-full bg-green-700 flex items-center justify-center text-white font-bold" style="font-size:10px">
                                        {{ mb_strtoupper(mb_substr(__('blog.p2_author'), 0, 1)) }}
                                    </div>
                                    <span>{{ __('blog.p2_author') }}</span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <time datetime="2026-02-20">{{ __('blog.p2_date') }}</time>
                                    <span>·</span>
                                    <span>{{ __('blog.p2_read_time') }}</span>
                                </div>
                            </footer>
                        </div>
                    </article>
                    ...
                    <article class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 card-hover flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            <span class="inline-block px-2.5 py-0.5 rounded-full bg-green-50 text-green-700 cat-badge font-bold uppercase tracking-wider mb-3 w-fit">{{ __('blog.p3_category') }}</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-3 leading-snug">
                                <a href="#" class="hover:text-green-700 transition">{{ __('blog.p3_title') }}</a>
                            </h3>
                            <p class="text-gray-500 text-sm leading-relaxed flex-1 mb-5">{{ __('blog.p3_excerpt') }}</p>
                            <footer class="flex items-center justify-between text-xs text-gray-400 pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center text-white font-bold" style="font-size:10px">
                                        {{ mb_strtoupper(mb_substr(__('blog.p3_author'), 0, 1)) }}
                                    </div>
                                    <span>{{ __('blog.p3_author') }}</span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <time datetime="2026-02-15">{{ __('blog.p3_date') }}</time>
                                    <span>·</span>
                                    <span>{{ __('blog.p3_read_time') }}</span>
                                </div>
                            </footer>
                        </div>
                    </article>
                    ...
                    <article class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 card-hover flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            <span class="inline-block px-2.5 py-0.5 rounded-full bg-green-50 text-green-700 cat-badge font-bold uppercase tracking-wider mb-3 w-fit">{{ __('blog.p4_category') }}</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-3 leading-snug">
                                <a href="#" class="hover:text-green-700 transition">{{ __('blog.p4_title') }}</a>
                            </h3>
                            <p class="text-gray-500 text-sm leading-relaxed flex-1 mb-5">{{ __('blog.p4_excerpt') }}</p>
                            <footer class="flex items-center justify-between text-xs text-gray-400 pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center text-white font-bold" style="font-size:10px">
                                        {{ mb_strtoupper(mb_substr(__('blog.p4_author'), 0, 1)) }}
                                    </div>
                                    <span>{{ __('blog.p4_author') }}</span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <time datetime="2026-02-10">{{ __('blog.p4_date') }}</time>
                                    <span>·</span>
                                    <span>{{ __('blog.p4_read_time') }}</span>
                                </div>
                            </footer>
                        </div>
                    </article>
                    ...
                    <article class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 card-hover flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            <span class="inline-block px-2.5 py-0.5 rounded-full bg-green-50 text-green-700 cat-badge font-bold uppercase tracking-wider mb-3 w-fit">{{ __('blog.p5_category') }}</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-3 leading-snug">
                                <a href="#" class="hover:text-green-700 transition">{{ __('blog.p5_title') }}</a>
                            </h3>
                            <p class="text-gray-500 text-sm leading-relaxed flex-1 mb-5">{{ __('blog.p5_excerpt') }}</p>
                            <footer class="flex items-center justify-between text-xs text-gray-400 pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-full bg-green-700 flex items-center justify-center text-white font-bold" style="font-size:10px">
                                        {{ mb_strtoupper(mb_substr(__('blog.p5_author'), 0, 1)) }}
                                    </div>
                                    <span>{{ __('blog.p5_author') }}</span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <time datetime="2026-02-05">{{ __('blog.p5_date') }}</time>
                                    <span>·</span>
                                    <span>{{ __('blog.p5_read_time') }}</span>
                                </div>
                            </footer>
                        </div>
                    </article>
                    ...
                    <article class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 card-hover flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            <span class="inline-block px-2.5 py-0.5 rounded-full bg-green-50 text-green-700 cat-badge font-bold uppercase tracking-wider mb-3 w-fit">{{ __('blog.p6_category') }}</span>
                            <h3 class="text-lg font-bold text-gray-900 mb-3 leading-snug">
                                <a href="#" class="hover:text-green-700 transition">{{ __('blog.p6_title') }}</a>
                            </h3>
                            <p class="text-gray-500 text-sm leading-relaxed flex-1 mb-5">{{ __('blog.p6_excerpt') }}</p>
                            <footer class="flex items-center justify-between text-xs text-gray-400 pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center text-white font-bold" style="font-size:10px">
                                        {{ mb_strtoupper(mb_substr(__('blog.p6_author'), 0, 1)) }}
                                    </div>
                                    <span>{{ __('blog.p6_author') }}</span>
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <time datetime="2026-01-28">{{ __('blog.p6_date') }}</time>
                                    <span>·</span>
                                    <span>{{ __('blog.p6_read_time') }}</span>
                                </div>
                            </footer>
                        </div>
                    </article>
                ...
                {{-- Coming soon notice --}}
                <p class="text-center text-sm text-gray-400 mt-10 italic">{{ __('blog.coming_soon') }}</p>
        ...
        <section class="hero-bg relative overflow-hidden py-20">
            ...
            <div class="relative max-w-2xl mx-auto px-6 text-center">
                <h2 class="text-3xl md:text-4xl font-extrabold text-white mb-4 leading-snug">{{ __('blog.cta_title') }}</h2>
                <p class="text-green-100 mb-8 leading-relaxed">{{ __('blog.cta_subtitle') }}</p>
