                        ...
                        <div class="relative">
                            <button onclick="document.getElementById('notificationDropdown').classList.toggle('hidden')"
                                ...
                                @if(auth()->user()->unreadNotifications->count() > 0)
                                    <span
                                        class="absolute top-1 {{ app()->getLocale() === 'ar' ? 'left-1' : 'right-1' }} w-5 h-5 bg-red-500 rounded-full text-white text-xs flex items-center justify-center font-bold">
                            ...
                            <div id="notificationDropdown"
                                class="hidden absolute {{ app()->getLocale() === 'ar' ? 'left-0' : 'right-0' }} mt-2 w-80 sm:w-96 bg-white rounded-lg shadow-lg z-50 border border-gray-200 max-h-96 overflow-y-auto">
                                ...
                                @empty
                                    <div class="px-4 py-8 text-center text-gray-500">
                                        ...
                                        <p class="text-sm">{{ __('app.no_notifications') }}</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
