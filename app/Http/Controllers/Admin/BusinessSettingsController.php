...
class BusinessSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'gallery_image_1' => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp', 'max:10240'],
            'gallery_image_2' => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp', 'max:10240'],
            'gallery_image_3' => ['nullable', 'image', 'mimes:jpeg,jpg,png,webp', 'max:10240'],
